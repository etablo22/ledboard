...
/*максимальное количество циклов между первым и вторым нажатием кнопки для двойного щелчка*/
...
/*размер буфера событий. Его значение должно быть кратно степени двойки (2, 4, 8, 16...).*/
